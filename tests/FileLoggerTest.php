...
final class FileLoggerTest extends TestCase
{
    ...
    public function path_is_normalized(): void
    {
        ...
        $filePathHasMultipleSlashes = str_contains(
    ...
    public function interpolation(): void
    {
        ...
        $this->assertStringContainsString(
            ...
            'Log file should contain the interpolated message',
        );
    }
    ...
    public function non_stringable_context_value_is_skipped(): void
    {
        ...
        $this->assertStringContainsString(
            '{user}',
            (string) $logFileContents,
            'Non-stringable values should leave their placeholder intact',
        );
    }
    ...
    public function exception_context_key_is_interpolated_with_its_message(): void
    {
        ...
        $this->assertStringContainsString(
            ...
            (string) $logFileContents,
            'Throwable in the exception key should render its message',
        );
    }
    ...
    public function new_lines_between_log_entries(): void
    {
        ...
        foreach ($messages as $message) {
            $this->assertStringContainsString(
                $message,
                (string) $logFileContents,
                sprintf('The log file should contain the message: "%s"', $message),
            );
        }
